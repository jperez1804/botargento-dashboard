...
export const realEstate: VerticalConfig = {
  ...
  crm: {
    ...
    qualificationFields: [
      ...
      { source: "escalation", key: "target_zone", label: "Zona", display: "chip" },
      { source: "escalation", key: "property_type", label: "Tipo", display: "chip" },
      { source: "escalation", key: "bedrooms", label: "Ambientes", display: "chip" },
      {
        source: "escalation",
        key: "budget_amount",
        label: "Presupuesto",
      ...
      { source: "escalation", key: "purchase_timing", label: "Plazo", display: "chip" },
    ...
    activityStages: { visit: "visita", meeting: "visita" },
